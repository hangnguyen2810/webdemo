...
public partial class Checkout : System.Web.UI.Page
{
    ...
    public void BindGrid(ShoppingCart aCart)
    {
        ...
        {
            lblPhiship.Text = "Phí Vận Chuyển: 30,000 VNĐ";
    ...
    protected void btnDatHang_Click(object sender, EventArgs e)
    {
        ...
        if (Session["Cart"] != null)
        {
            ...
            {
                SqlDsDonhang.InsertParameters["tongtien"].DefaultValue = (aCart.TongTien+30000).ToString();
            ...
            {
               SqlDsDonhang.InsertParameters["hinhthucthanhtoan"].DefaultValue = "Chuyển khoản ngân hàng- Mã thẻ " +txtmathe.Text;
          }
            try
            {
