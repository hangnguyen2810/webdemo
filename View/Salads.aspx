<%@ Page Title="" Language="C#" MasterPageFile="~/View/MasterPageKhachHang.master" AutoEventWireup="true" CodeFile="Salads.aspx.cs" Inherits="Salads" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="noidung" Runat="Server">
    <div class="content-main">
        <div class="container">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NHAHANG19ConnectionString4 %>"
                SelectCommand="SELECT [mamonan], [tenmonan], [gia], [anh] FROM [MON_AN] where[maloaimonan]='B'"></asp:SqlDataSource>
        </div></div>
    </div>
</asp:Content>
