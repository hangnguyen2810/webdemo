<%@ Page Title="" Language="C#" MasterPageFile="~/View/MasterPageKhachHang.master" AutoEventWireup="true" CodeFile="Sashimi.aspx.cs" Inherits="Sashimi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="noidung" Runat="Server">
    <div class="content-main">
        <div class="container">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NHAHANG19ConnectionString3 %>"
                SelectCommand="SELECT [mamonan], [tenmonan], [gia], [anh] FROM [MON_AN] where[maloaimonan]='C'"></asp:SqlDataSource>
        </div></div>
    </div>
</asp:Content>
