<%@ Page Title="" Language="C#" MasterPageFile="~/View/MasterPageKhachHang.master" AutoEventWireup="true" CodeFile="Sunomono.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="noidung" Runat="Server">
    <div class="content-main">
        <div class="container">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NHAHANG19ConnectionString2 %>"
                SelectCommand="SELECT [mamonan], [tenmonan], [gia], [anh] FROM [MON_AN] where [maloaimonan]='D'"></asp:SqlDataSource>
        </div></div>
    </div>
</asp:Content>
