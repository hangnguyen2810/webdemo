<%@ Page Title="" Language="C#" MasterPageFile="~/View/MasterPageKhachHang.master" AutoEventWireup="true" CodeFile="Sushi.aspx.cs" Inherits="Sushi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="noidung" Runat="Server">
    <div class="content-main">
        <div class="container">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NHAHANG19ConnectionString %>"
                
                    SelectCommand="SELECT [mamonan], [tenmonan], [gia], [anh] FROM [MON_AN] WHERE ([maloaimonan] = @maloaimonan)">
                <SelectParameters>
                    <asp:QueryStringParameter DefaultValue="E" Name="maloaimonan" 
                        QueryStringField="maloaimonan" Type="String" />
                </SelectParameters>
                </asp:SqlDataSource>
        </div></div>
    </div>
