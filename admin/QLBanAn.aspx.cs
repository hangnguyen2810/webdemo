...
public partial class QLBanAn : System.Web.UI.Page
{
    ...
    protected void btnsearch_Click(object sender, EventArgs e)
    {
        ...
        dt.SelectCommand = "SELECT * FROM BAN_AN WHERE maban LIKE'%" + txt + "%' OR socho LIKE N'%" + txt + "%'";
        grdbanan1.DataSource = dt;
        grdbanan1.DataBind();
    }
