...
public partial class Thembanan : System.Web.UI.Page
{
    ...
    protected void InsertCmd(object sender, FormViewInsertedEventArgs e)
    {
        if (e.Exception != null)
        {
            ...
            errmg.Text = "Co loi xay ra" + e.Exception.Message;
        }
    }
    protected void sochoTextBox_TextChanged(object sender, EventArgs e)
    {
